...
## OPC UA nodoak eta OPC-UA Handler subflow-a Node Red garbi batean instalatzeko prosezua:
![enter image description here](Irudiak/OPC-UA handler.png "OPCUA Handler")





**OPC UA** https://opcfoundation.org/ nodoak Nodo Rede- OPC UA tramak irakurri naiz idazteko erabiliko ditugun nodoak dira. Nodo hauek dituen modulua instalatu behar da lehenengo eta hori egin ostean @bodiroga-k TKNIKAN sorturiko OPC-UA HANDLER subflow-a.
...
OPCUA nodoak Node Red Instalazio orokor batean instalatzeko. Windows:

NodeJS 14 bertsioko azken aktualizazioa instalatu (.msi) 14.18.3 https://nodejs.org/en/download/releases/
